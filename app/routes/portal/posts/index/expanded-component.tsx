...
const ExpandedComponent = ({ onExpand, postData }: ExpandedComponentProps) => {
    ...
    return (
        ...
        <div className="bg-transparent pl-2 md:border-r border-gray-700 flex flex-col p-4">
            ...
            <div>
                ...
                <img
                    src={postData.image}
                    alt="Expand"
                    className="w-full md:w-40 h-40 rounded-md"
                />
            </div>
            <div>
                <p>
        ...
        <div className="mb-12">
            ...
            <div className="bg-transparent p-4 rounded-lg h-64 md:h-[calc(100vh-32rem)] overflow-y-auto">
                {comments.map((comment, index) => (
                    <div key={index} className="flex flex-col mb-3">
                        ...
                        />
                        <span
                            className="text-xs text-blue-500 pl-4 md:pl-[15%] cursor-pointer hover:opacity-80"
                        ...
                        {showReplyInput[index] && (
                            <div className="flex items-center mt-2 pl-4 md:pl-[15%]">
                                <input
                                    type="text"
                        ...
                        <div className="pl-4 md:pl-[15%] mt-2">
            ...
            <div className="absolute -bottom-2 bg-transparent p-2 md:p-[10px] w-full md:w-[52%] right-0 md:-right-2 border-t border-gray-700">
